...
document.addEventListener("keydown", onStageKeyDown, false);
document.addEventListener("keyup", onStageKeyUp, false);

function onStageKeyDown(evt) {
	Input.KeysDown[evt.keyCode] = true;
}

function onStageKeyUp(evt) {
